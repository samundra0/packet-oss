      ...
      <div className="fixed inset-x-0 top-0 z-50 bg-white rounded-b-3xl max-h-[85vh] overflow-y-auto md:hidden animate-in slide-in-from-top duration-300">
        <div className="p-6">
          ...
          <div className="space-y-1">
            ...
            <a href="/docs/api-reference" target="_blank" rel="noopener noreferrer" className="w-full flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-zinc-50 transition-colors">
              <svg className="w-5 h-5 text-zinc-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
